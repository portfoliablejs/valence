import{i as e}from"./preload-helper-CT_b8DTk.js";import{Ct as t,bt as n}from"./iframe-DInCeyBe.js";import{r,t as i}from"./if-defined-CceMvhO9.js";import{t as a}from"./Pill-D9tzP_uM.js";var o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x;e((()=>{n(),i(),a(),{expect:o}=__STORYBOOK_MODULE_TEST__,s={title:`Atoms/Pill [v1.0.0]`,component:`ds-pill`,tags:[`autodocs`],parameters:{layout:`centered`,docs:{description:{component:`
...
When configured with \`variant="telemetry"\`, it can automatically read and update directly from browser APIs.
  ...
  `,play:async({canvasElement:e,step:t})=>{let n=e.querySelectorAll(`ds-pill`);await t(`Verify all 8 telemetry pills render in the gallery suite`,async()=>{o(n.length).toBe(8)}),await t(`Verify each pill in the suite has updated its text content`,async()=>{n.forEach(e=>{let t=e.shadowRoot.querySelector(`.pill-label`);o(t.textContent.length).toBeGreaterThan(0)})})}},b={parameters:{docs:{description:{story:"Illustrates sub-atomic design token overrides via inline CSS variables (`--ds-pill-bg`, `--ds-pill-color`, `--ds-pill-radius`)."}}},args:{variant:`default`,label:`Custom Theme`,radius:`4px`,backgroundColor:`#5856D6`,textColor:`#FFFFFF`},play:async({canvasElement:e,step:t})=>{let n=e.querySelector(`ds-pill`);await t(`Verify inline custom CSS tokens exist on host element`,async()=>{let e=n.getAttribute(`style`);o(e).toContain(`--ds-pill-bg: #5856D6`),o(e).toContain(`--ds-pill-color: #FFFFFF`),o(e).toContain(`--ds-pill-radius: 4px`)})}},c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
