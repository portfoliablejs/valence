...
export class AudioPlayer extends HTMLElement {
  ...
  constructor() {
    ...
    this.shadowRoot.innerHTML = `<style>${css}</style><div class="case-audio-player" tabindex="0" role="region" aria-label="Audio Player"><div class="audio-player-header"><span class="header-label">Reader</span></div><div class="audio-player-controls-row"><div class="tooltip-wrapper"><ds-button tabindex="0" variant="tertiary" has-text="false" has-icon class="play-btn" icon="play-fill" aria-label="Play"></ds-button><ds-tooltip class="play-tooltip" text="Play" show-kbd="" kbd-label="⇧ Shift" kbd-show-plus="" kbd-key="p" position="top"></ds-tooltip></div><ds-seek-bar class="audio-seek" percent="0" show-tooltip="false" aria-label="Audio position"></ds-seek-bar><span class="audio-time-label">0:00 / 0:00</span><ds-divider orientation="vertical"></ds-divider><div class="volume-container"><div class="tooltip-wrapper"><ds-button tabindex="0" variant="tertiary" has-text="false" has-icon class="volume-btn" icon="volume-on" aria-label="Mute sound"></ds-button><ds-tooltip class="volume-tooltip" text="Mute" show-kbd="" kbd-label="⇧ Shift" kbd-show-plus="" kbd-key="m" position="top"></ds-tooltip></div><div class="volume-seek-wrapper tooltip-wrapper"><ds-seek-bar class="volume-seek" percent="100" show-tooltip="false" aria-label="Volume level"></ds-seek-bar><ds-tooltip class="volume-seek-tooltip" text="Volume" position="top"></ds-tooltip></div></div><ds-divider orientation="vertical"></ds-divider><div class="tooltip-wrapper"><ds-button tabindex="0" variant="tertiary" has-text="false" has-icon class="speed-btn" icon="playback-1x" aria-label="Playback speed"></ds-button><ds-tooltip class="speed-tooltip" text="Speed" show-kbd="" kbd-label="⇧ Shift" kbd-show-plus="" kbd-key="s" position="top"></ds-tooltip></div><div class="tooltip-wrapper"><ds-button tabindex="0" variant="tertiary" has-text="false" has-icon class="hide-btn" icon="eye-open" aria-label="Hide while scrolling"></ds-button><ds-tooltip class="hide-tooltip" text="Hide while scrolling" show-kbd="" kbd-label="⇧ Shift" kbd-show-plus="" kbd-key="h" position="top"></ds-tooltip></div><div class="tooltip-wrapper"><ds-button tabindex="0" variant="tertiary" has-text="false" has-icon class="autoscroll-btn" icon="autoscroll" aria-label="Auto-scroll with audio"></ds-button><ds-tooltip class="autoscroll-tooltip" text="Auto-scroll with audio" show-kbd="" kbd-label="⇧ Shift" kbd-show-plus="" kbd-key="a" position="top"></ds-tooltip></div></div></div>`;
