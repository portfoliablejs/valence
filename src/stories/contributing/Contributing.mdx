...
<Meta title="Contributing/Open-source" />
...
We use the [Conventional Commits](https://www.conventionalcommits.org/) specification. This helps us automate changelogs and makes the project history easy to read. Your commit messages should be structured as follows: `\<type\>[\<optional scope\>]: \<description\>` for commit messages.
...
If you have questions, ideas, or just want to connect, you can find the project's sole founder here:
